...
if (!isset($_GET['id'])) {
    header('Location: ../data/data-pelanggan.php');
    exit();
}
...
$query = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE idpelanggan = '$idpelanggan'");
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    ...
                    <h3 class="text-center mt-3">Form Ubah Data Pelanggan</h3>
                    <form action="../proses/proses-pelanggan.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nopelanggan" name="nopelanggan" value="<?php echo $data['nopelanggan']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="emailpelanggan">Email Pelanggan</label>
                            <input type="text" class="form-control" id="emailpelanggan" name="emailpelanggan" value="<?php echo $data['emailpelanggan']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="alamatpelanggan" class="form-label">Alamat Pelanggan</label>
                            <textarea rows="6" class="form-control" id="alamatpelanggan" name="alamatpelanggan" required><?php echo $data['alamatpelanggan']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="tanggalpelanggan">Tanggal Daftar Pelanggan</label>
                            <input type="date" class="form-control" id="tanggalpelanggan" name="tanggalpelanggan" value="<?php echo $data['tanggalpelanggan']; ?>" required>
                        </div>
                        <div class="mb-3">
