...
if (!isset($_GET['id'])) {
    header('Location: ../data/data-aktivitas.php');
    exit();
}

$idaktivitas = $_GET['id'];
$_SESSION['idaktivitas'] = $idaktivitas;

$query = mysqli_query($koneksi, "SELECT * FROM aktivitas WHERE idaktivitas = '$idaktivitas'");
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    ...
                    <a href="../data/data-aktivitas.php" class="btn btn-warning" title="Kembali"><i class="bi-arrow-left"></i> Kembali</a>
                    <h3 class="text-center mt-3">Form Ubah Data Aktivitas</h3>
                    <form action="../proses/proses-aktivitas.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="namaaktivitas">Nama Aktivitas</label>
                            <input type="text" class="form-control" id="namaaktivitas" name="namaaktivitas" value="<?php echo $data['namaaktivitas']; ?>" required>
                        </div>
                        <div class="mb-3">
