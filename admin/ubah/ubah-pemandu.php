...
if (!isset($_GET['id'])) {
    header('Location: ../data/data-pemandu.php');
    exit();
}

$idpemandu = $_GET['id'];
$_SESSION['idpemandu'] = $idpemandu;

$query = mysqli_query($koneksi, "SELECT * FROM pemandu WHERE idpemandu = '$idpemandu'");
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    ...
                    <h3 class="text-center mt-3">Form Ubah Data Pemandu</h3>
                    <form action="../proses/proses-pemandu.php" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="profilpemandu" name="coverpemandu">
                        </div>
                        <div class="mb-3">
                            <label for="namapemandu">Nama Pemandu</label>
                            <input type="text" class="form-control" id="namapemandu" name="namapemandu" value="<?php echo $data['namapemandu']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label mb-2">Gender Pemandu</label>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="genderpemandu" id="genderpemandu1" value="laki - laki" <?php echo $data['genderpemandu'] == 'laki - laki' ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="genderpemandu1">Laki - laki</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="genderpemandu" id="genderpemandu2" value="perempuan" <?php echo $data['genderpemandu'] == 'perempuan' ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="genderpemandu2">Perempuan</label>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="tanggalpemandu">Tanggal Masuk Pemandu</label>
                            <input type="date" class="form-control" id="tanggalpemandu" name="tanggalpemandu" value="<?php echo $data['tanggalpemandu']; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="mb-2">Status Pemandu</label>
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" name="statuspemandu" id="statuspemandu1" value="1" <?php if($data['statuspemandu'] == '1'){echo 'checked';} ?>>
                                <label class="form-check-label" for="statuspemandu1">Aktif</label>
                            </div>
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="radio" name="statuspemandu" id="statuspemandu2" value="0" <?php if($data['statuspemandu'] == '0'){echo 'checked';} ?> >
                                <label class="form-check-label" for="statuspemandu2">Tidak Aktif</label>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="asalpemandu">Asal Pemandu</label>
                            <input type="text" class="form-control" id="asalpemandu" name="asalpemandu" value="<?php echo $data['asalpemandu']; ?>" required>
                        </div>
                        <div class="mb-3">
