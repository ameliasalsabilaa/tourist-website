...
<body>
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    <a href="../tambah/tambah-paket.php" class="btn btn-primary mb-2" title="Tambah paket"><i class="bi-plus"></i> Tambah Paket</a>
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0 rounded" id="tabelpaket" width="100%">
                            <thead class="thead-light">
                                <tr>
                                    <th class="border-0 rounded-start">No</th>
                                    <th class="border-0">Cover </th>
                                    <th class="border-0">Nama </th>
                                    <th class="border-0">Destinasi </th>
                                    <th class="border-0">Pemandu </th>
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT paket.idpaket, namapaket, coverpaket, hargapaket, tanggalpaket, statuspaket, GROUP_CONCAT(juduldestinasi) AS destinasi, COALESCE(namapemandu, 'Tanpa Pemandu') AS namapemandu
                                FROM paket
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><img src="../../assets/cover/<?php echo $data['coverpaket']; ?>"  width="50" height="50" class="img-fluid rounded-2"/></td>
                                    <td><?php echo $data['namapaket']; ?></td>
                                    <td><?php echo str_replace(',', ', ', $data['destinasi']); ?></td>
                                    <td><?php echo $data['namapemandu']; ?></td>
                                    <td><?php echo 'Rp ' . number_format($data['hargapaket'], 0, ',', '.'); ?></td>
                                    <td data-date="<?php echo $data['tanggalpaket']; ?>"></td>
                                        <td><?php echo $status; ?></td>
                                    <td>
                                        <a href="../ubah/ubah-paket.php?id=<?php echo $data['idpaket'];?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i></a>
                                        <a href="../proses/proses-paket.php?id=<?php echo $data['idpaket'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
