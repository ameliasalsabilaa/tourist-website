...
<body>
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    <a href="../tambah/tambah-pemandu.php" class="btn btn-primary mb-2" title="Tambah pemandu"><i class="bi-plus"></i> Tambah Pemandu</a>
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0 rounded" id="tabelpemandu" width="100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT * FROM pemandu");
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><img src="../../assets/cover/<?php echo $data['coverpemandu']; ?>"  width="50" height="50" class="img-fluid rounded-2"/></td>
                                    <td><?php echo $data['namapemandu']; ?></td>
                                    <td><?php echo $data['genderpemandu']; ?></td>
                                    <td data-date="<?php echo $data['tanggalpemandu']; ?>"></td>
                                    <td><?php echo $data['asalpemandu']; ?></td>
                                        <td><?php echo $status; ?></td>
                                    <td>
                                        <a href="../ubah/ubah-pemandu.php?id=<?php echo $data['idpemandu'];?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i></a>
                                        <a href="../proses/proses-pemandu.php?id=<?php echo $data['idpemandu'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
