...
<!-- NOTICE: You can use the _analytics.html partial to include production code specific code & trackers -->
    ...
    <?php include 'menu-atas.php'; ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-body">
                    <a href="../tambah/tambah-aktivitas.php" class="btn btn-primary mb-2" title="Tambah aktivitas"><i class="bi-plus"></i> Tambah Aktivitas</a>
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0 rounded" id="tabelaktivitas" width="100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT * FROM aktivitas");
                                while($data = mysqli_fetch_assoc($sql)) {
                                ?>
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?php echo $data['idaktivitas']; ?></td>
                                    <td><?php echo $data['namaaktivitas']; ?></td>
                                    <td>
                                        <a href="../ubah/ubah-aktivitas.php?id=<?php echo $data['idaktivitas'];?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i></a>
                                        <a href="../proses/proses-aktivitas.php?id=<?php echo $data['idaktivitas'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
